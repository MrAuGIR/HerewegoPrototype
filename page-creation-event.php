<?php
$titlePage = "Création d'un évènement";
$h1 = "Création d'un évènement";
    ...
    <div class="row">
        ...
        <div class="col-10">
            ...
            <form>
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Titre de votre event</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="date de début">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Se termine le :</label>
                    <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="date de fin">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" value="organisateur@email.com">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">numero de l'event</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="numero de téléphone">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">site web de l'event</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="site web de l'event">
                </div>
                <div class="w-100">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="facebook de l'event">
                    </div>
                    <div class="col-6">
                        <label for="exampleFormControlInput1" class="form-label">Twitter</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Twitter de l'event">
                    </div>
                    <div class="col-6">
                        <label for="exampleFormControlInput1" class="form-label">Instagram</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Instagram de l'event">
                    </div>
                </div>
                <div class="w-100">
                ...
                <div class="mb-3 pb-5 border-bottom">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="liste de vos tags">
                </div>
                <div class="row">
                    <div class="col-12">
                        <h6>Vos images</h6>
