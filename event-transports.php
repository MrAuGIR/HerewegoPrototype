...
<div class="row w-100">
    ...
    <div class="col-3 text-center bg-info border border-white">Horaires Départ</strong></div>
    <div class="col-3 text-center bg-info border border-white">Horaires Arrivée</strong></div>
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="headingOne">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                <div class="row w-100">
                    <div class="col-3">Parc de Blossac - Poiters</div>
                    <div class="col-3">Départ à <strong>9h le 12/05/21</strong></div>
                    <div class="col-3">Retour à <strong>19h le 12/05/21</strong></div>
                    <div class="col-3"><strong>2 places</strong> restantes</div>
                </div>
            </button>
        </h2>
